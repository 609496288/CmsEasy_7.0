...
<script type="text/javascript" language="JavaScript">
	...
	var digheight="440";
	var rootDIR="";
	var fileview="index.php?case=file&act=netfile2";
...
<div class="centerrightwindow"  style="background-color: #FFFFFF">
	<div id="mainwindowtab">
            ...
            <li id="tabbottonul2" href="#body" onmousedown="javascript:windowsclass('#tabbottonul2','#tabcontentdiv2','tabbottonul','tabcontentdiv',2,4,'hover','hover2');flushiframe('netpic');">网络视频</li>
		</ul>
			</div>
	<div id="mainwindowstr">
		<div id="tabcontentdiv1" class="displaytrue"><iframe name="upfilewindow" class="upfilewindow" src="index.php?case=file&act=upfile3" width="100%" height="485" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
