...
var ie = browser.ie,
	...
	var lang = {
        ...
        'updateStatusReady': '选中_条视频，共_KB。',
        'updateStatusConfirm': '已成功上传_条视频，_条视频上传失败',
        'updateStatusFinish': '共_条（_KB），_条上传成功',
        'updateStatusError': '，_条上传失败。',
        ...
        'imageUrlError':"不允许的视频格式！",
        'imageLoadError':"视频加载失败！请检查链接地址或网络状态！",
        'searchRemind':"请输入搜索关键词",
        'searchLoading':"视频加载中，请稍后……",
        'searchRetry':" :( ，抱歉，没有找到视频！请重试一次！"
    }
	...
	UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                actionUrl = '<?php echo url('ueditor/index/action/uploadvideo',false);?>',
                acceptExtensions = '',
                imageMaxSize = {config::get('upload_max_filesize')} * 1024* 1024,
                imageCompressBorder = false;
				var acceptExtensions = 'mp4,mp3';
...
$(function(){
	...
	function insertPics(){
		...
		for(i=0;i<list.length;i++){
			parent.refile(list[i].src,0,$('#autoplay').prop('checked')?'true':'false',$('#width').val(),$('#height').val());
		}
	}
</script>
<style>
	...
	.col-md-6 {width:50%;display:inline;}.blank30 {clear:both;height:30px;}
	</style>
</head>
...
<div id="upload" class="panel focus">
    ...
    自动播放：<input type="checkbox" name="autoplay" id="autoplay" value="1" />  宽度：<input style="width: 40px;" type="text" name="width" id="width" value="" class="config"> PX 高度：<input style="width: 40px;" type="text" name="height" id="height" value="" class="config"> PX

<div class="blank5"></div>
<div class="blank10"></div>
  <div id="subbotton">
<input type="button" name="Submit" id="submitbotton" value="确认文件上传" class="buttonface" title="确认文件上传" onclick="insertPics()"/>&nbsp</div>
