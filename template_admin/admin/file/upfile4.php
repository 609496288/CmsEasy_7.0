...
var ie = browser.ie,
	...
	var lang = {
        ...
        'updateStatusReady': '选中_条音频，共_KB。',
        'updateStatusConfirm': '已成功上传_条音频，_条音频上传失败',
        ...
        'imageUrlError':"不允许的音频格式！",
        'imageLoadError':"音频加载失败！请检查链接地址或网络状态！",
...
$(function(){
	...
	function insertPics(){
		...
		for(i=0;i<list.length;i++){
			parent.refile(list[i].src,0,$('#autoplay').prop('checked'),$('#width').val(),$('#height').val());
		}
	}
</script>
<style>
