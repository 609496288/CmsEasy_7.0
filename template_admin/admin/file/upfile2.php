...
$(function(){
	...
	function insertPics(){
		...
		for(i=0;i<list.length;i++){
			parent.refile(list[i].src,0,list[i].alt,$('#width').val(),$('#height').val());
		}
        parent.closeModel('imageModel');
	}
</script>
<style>
	.queueList{width: 100%;}
...
<div id="upload" class="panel focus">
            ...
            宽度：<input type="text" name="width" id="width" value="" class="config"> PX&nbsp&nbsp&nbsp&nbsp高度：<input type="text" name="height" id="height" value="" class="config"> PX
