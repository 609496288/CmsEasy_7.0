...
<script type="text/javascript" language="JavaScript">
	...
	var digheight="440";
	var rootDIR="";
	var picview="index.php?case=file&act=ps1&max={front::get('max')}";
	var fileview="index.php?case=file&act=netfile1";
    ...
    function refilediv(filename,alt,width,height){
        parent.refilediv(filename,alt,width,height);
    }
...
<div class="centerrightwindow"  style="background-color: #FFFFFF">
	...
	<div id="mainwindowstr">
		<div id="tabcontentdiv1" class="displaytrue"><iframe name="upfilewindow" class="upfilewindow" src="index.php?case=file&act=upfile2" width="100%" height="485" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
