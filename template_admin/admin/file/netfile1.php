...
<body class="bodyflow">
<form name="upfile" id="upfile" method="post" action="index.php?case=file&act=netfilesave1&admin_dir={get('admin_dir')}">
		...
		<div class="maneditcontent">
			<table class="formtablewin">
				<tr class="trstyle2">
					...
					<td class="trtitle02" id="upfilepath"><input type="text" name="upfilepath" maxlength="200" size="30" class="infoInput">
				    必须以http://开头</td>
				</tr>
                 <tr class="trstyle2">
				  <td class="trtitle01">图片说明</td>
					<td class="trtitle02" id="upfilepath">
				    <input type="text" name="alt" id="alt" size="10" />
				    宽
