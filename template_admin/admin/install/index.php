...
<link type="text/css" rel="stylesheet" media="all" href="{$skin_admin_path}/css/install.css" />
</head>
<body>
<div id="header">
<div class="box">
<img src="{$skin_admin_path}/images/logo.png" class="logo" />
</div>
<div class="top_right">
<ul>
...
<?php
 ...
 {if isset($install)}
<style type="text/css">
.go {background:url({$skin_admin_path}/images/go_4.gif) center top no-repeat;}
</style>
<div class="result">
...
{if front::$get['step']==1}
<style type="text/css">
.go {background:url({$skin_admin_path}/images/go_2.gif) center top no-repeat;}
</style>
...
<td align="center"></td>
 ...
 <tr>
     <td>php_mysqli</td>
     <td>安装并启用</td>
     <td><?php echo $mysqli?'已启用':'未安装'; ?></td>
     <td align="center"><?php echo helper::yes($mysqli); ?></td>
 </tr>
 </thead>
...
<tr>
 ...
 <tr>
 <td><?php echo '/html/upload';?></td> <td colspan="4"><?php echo helper::yes(front::file_mode_info(ROOT.'/html/upload')>=2);  ?></td>
 </tr>
 <tr>
...
{/if}
<style type="text/css">
.go {background:url({$skin_admin_path}/images/go_3.gif) center top no-repeat;}
</style>
<tbody>
 <tr>
...
<center><input type="button" onclick="window.location.href='<?php echo url('install/index/step/1',true);?>';"  class="btn_b" value=" 上一步 "style="margin-right:20px;" />
<input type="submit" name="dosubmit"  class="btn_a" value=" 保存数据库信息 " /></center>
...
<tbody>
 ...
 <center><input type="button" onclick="window.location.href='<?php echo url('install/index/step/2',true);?>';"  class="btn_b" value=" 上一步 "style="margin-right:20px;" />
<input type="hidden" name="install" value="1"/>
<input type="submit" id="installbutton" name="dosubmit" value=" 安装 " class="btn_a" onclick="changebutton();if(!confirm('你确实要把数据安装在数据库 [ '+this.form.database.value+' ] 吗？')) return false;"/></center>
