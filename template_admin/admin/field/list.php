...
<a href="<?php echo modify("/act/list/table/".$table);?>" class="btn btn-info">查看列表</a>
...
<a href="<?php echo modify("/act/edit/table/$table/name/".$f['name']);?>" title="编辑"><i class="glyphicon glyphicon-edit"></i></a>
<a onclick="return confirm('确实要删除这个字段吗?');" href="<?php echo modify("/act/delete/table/$table/name/".$f['name']);?>" title="删除"><i class="glyphicon glyphicon-trash"></i></a>
</td>
</tr>
{/loop}
</tbody>
