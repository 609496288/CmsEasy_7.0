...
<td align="left"><a href="{url('adminlogs/delete/id/'.$d['id'])}" onClick="return confirm('确定要删除吗?')" title="删除"><i class="glyphicon glyphicon-trash"></i></a></td>
</tr>
{/loop}
</table>
</div>
...
<input  class="btn btn-primary" type="button" value=" 全部清空 " name="delete" onclick="if(confirm('确实要清空日志记录吗?')){this.form.action='<?php echo modify('act/batch',true);?>'; this.form.batch.value='delete'; this.form.submit();}"/>
