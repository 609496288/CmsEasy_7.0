<!-- 组件 -->
    ...
    <span class="drag drag-container label label-default btn-sections-config" data-target="#div-config" role="button" data-toggle="modal" title="层属性"><i class="glyphicon glyphicon-cog"></i></span>
                                            <div class="preview">
                                                <img src="{$skin_admin_path}/images/visual/section/map.png">
												<p>地图</p>
                                            </div>
                                            <div class="view">
<div class=" visual-ditu">
                                                <div class="custtag" rel="template 'ditu.html'">
													<center><img src="{$skin_admin_path}/images/visual/section/map.jpg" class="img-responsive" style="width:100%"></center>
