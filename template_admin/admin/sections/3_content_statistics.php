<!-- 模块样例一 -->
    ...
    <span class="drag drag-container label label-default div-drag" data-target="#div-config" role="button" data-toggle="modal" title="层属性">
        <i class="glyphicon glyphicon-cog"></i>
                                            ...
                                            <div class="preview">
                                                <img src="{$skin_admin_path}/images/visual/section/statistics.png">
												<p>浏览统计</p>
                                            </div>
                                            <div class="view">
<div class="visual-category-statistics visual-inline-block">
											<div class="codearea">
												<p><span>#[#lang('view')#]#：</span>#[#view_js($archive[aid])#]#</p>
                                                </div>
                                                <div class="viewarea">
													<p><span>浏览：</span>819</p>
                                                </div>
