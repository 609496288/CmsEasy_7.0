...
<div class="visual-drag-box box-element">
    ...
    <span class="drag label label-default btn-tag-config" data-target="#template-field-tag" role="button" data-toggle="modal" title="设置">
            <i class="glyphicon glyphicon-pencil"></i></span>
	<div class="preview">
		<img src="{$skin_admin_path}/images/visual/section/content_field.png">
		<p>
			内容自定义字段
		</p>
	</div>
	<div class="view">
		<div class=" visual-conent-field">
			<div class="codearea">
			</div>
			<div class="viewarea">
                <span>字段名：</span>内容自定义字段
			</div>
		</div>
	</div>
</div>
