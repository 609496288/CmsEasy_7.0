...
<span class="drag drag-container label label-default div-drag" data-target="#div-config" role="button" data-toggle="modal" title="层属性"><i class="glyphicon glyphicon-cog" title="属性"></i></span>

                                    <div class="preview">
                                        <img src="{$skin_admin_path}/images/visual/section/content.png">
												<p>内容</p>
                                    </div>

                                    <div class="view visual-text">
									<div id="print" class=" visual-conent">
									<div class="codearea">
												#[#$archive['content']#]#
												<div class="clearfix"></div>
                                                </div>
                                                <div class="viewarea">
									<div class="visual-text-box" contenteditable="true">
