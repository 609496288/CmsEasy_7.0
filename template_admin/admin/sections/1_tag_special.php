...
<div class="visual-drag-box box-element">
    ...
    <span class="drag label label-default btn-tag-config" data-target="#template-special-tag" role="button"
          data-toggle="modal" title="设置"><i class="glyphicon glyphicon-pencil"></i></span>

    <div class="preview">
        <img src="{$skin_admin_path}/images/visual/section/tag_special.png">
        <p> 专题标签</p>
    </div>
    <div class="view">
        <div class=" tag">
