    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table1">
      ...
      <tr class="s_out" >
		...
		<dl>
			...
			<dd>
				<textarea name="txt" class="textarea gens nonull" value="{$data['txt']}" onfocus="if(this.value=='请填写回复内容！') {this.value=''}" onblur="if(this.value=='') this.value='请填写回复内容！'">{$data['txt']}</textarea><span class="hotspot" onmouseover="tooltip.show('微信能够识别电话号码，支持点击电话号码直接拨打！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
		...
		<dl>
			<dt><div class="blank10"></div></dt>
			<dd>
				<input name='num' type='text'  value='{$data['num']}' class="form-control" onfocus="if(this.value=='填写推送内容条数，最多10条！') {this.value=''}" onblur="if(this.value=='') this.value='填写推送内容条数，最多10条！'" /><span class="hotspot" onmouseover="tooltip.show('填写推送内容条数，最多10条！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
		<?php
...
<div class="img_upload">
                <input type="text" name="pic[]" id="pic{$i}"   class="form-control"  value='{$tmp[2]}' class="form-control" onfocus="if(this.value=='请填写图片调用地址') {this.value=''}" onblur="if(this.value=='') this.value='请填写图片调用地址'" /><a href='javascript:deletdisplayimg({$i});' class='displayimg_del'><img src="{$skin_admin_path}/images/no.gif" width="12" height="12" style="margin:2px 20px 0px 10px;" /></a><span class="hotspot" onmouseover="tooltip.show('填写图片调用地址！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin: -3px 5px 0px 0px; /"></span>
			...
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
					<input name='twname[]' type='text'  class="form-control"  value='{$tmp[0]}' class="form-control" onfocus="if(this.value=='请填写内容标题！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容标题！'" /><span class="hotspot" onmouseover="tooltip.show('填写内容标题！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
				<input name='twurl[]' type='text' value='{$tmp[1]}'  class="text nonull input" onfocus="if(this.value=='请填写内容链接地址！地址！地址！') {this.value=''}" onblur="if(this.value=='') this.value='请填写内容链接地址！地址！地址！'" /><span class="hotspot" onmouseover="tooltip.show('请填写内容链接地址！地址！地址！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
				</dd>
			</dl>
            <?php
			if($i == 1){
			...
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
					<textarea name="intro" class="textarea"  value="{$data['intro']}" onfocus="if(this.value=='请填写描述内容') {this.value=''}" onblur="if(this.value=='') this.value='请填写描述内容'">{$data['intro']}</textarea><span class="hotspot" onmouseover="tooltip.show('多图文内容展示时候，将不会显示描述内容！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dl>
            <?php
			}
			?>
