...
<tbody>
    ...
    <tr>
	  ...
	  <a href="<?php echo modify("act/edit/table/$table/id/$d[$primary_key]/bid/".front::$get['bid']);?>" title="编辑"><i class="glyphicon glyphicon-edit"></i></a>
	  <a onclick="javascript: return confirm('确实要删除吗?');" href="<?php echo modify("/act/delete/table/$table/id/$d[$primary_key]/token/$token"."/bid/".$ballot['id']);?>" title="删除"><i class="glyphicon glyphicon-trash"></i></a>
	  </td>
    </tr>
    {/loop}
    </tbody>
