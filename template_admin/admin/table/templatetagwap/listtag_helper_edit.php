...
?>
       ...
       echo '<div class="row"><div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">';
        ...
        echo form::input('introduce_length', $tag_config['introduce_length'], 'class="input_c"').'<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="right" title="-1：不限制 0：不调用"></span>';
        echo '</div></div><div class="clearfix blank20"></div>';
		echo '<div class="row"><div class="col-xs-4 col-sm-4 col-md-3 col-lg-2 text-right">';
        ...
        echo '<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="right" title="标签模板文件存放在&nbsp;template/当前使用模板目录/tpltag/tag_content_*.html!"></span><br/><div style="display:none">';
