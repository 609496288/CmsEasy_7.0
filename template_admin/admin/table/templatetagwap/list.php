...
<a href="{$base_url}/index.php?case=table&act=add&table=templatetagwap&tagfrom=category&admin_dir={get('admin_dir')}&site=default" class="btn btn-success">添加手机栏目标签</a>
<a href="{$base_url}/index.php?case=table&act=add&table=templatetagwap&tagfrom=define&admin_dir={get('admin_dir')}&site=default" class="btn btn-info">添加手机自定义标签</a>
...
<a href='<?php echo url("templatetagwap/test/id/$d[$primary_key]",false);?>' target="_blank" title="查看"><i class="glyphicon glyphicon-eye-open"></i></a>
<?php
