...
<input title="增加内链" onclick="window.location.href='{url::create('table/add/table/linkword')}'" type="button" name="addcontentlinkword" class="btn btn-primary" value="增加内链" />
