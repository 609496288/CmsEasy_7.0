...
<a href="<?php echo url("type/list/typeid/$d[$primary_key]",false);?>" target="_blank" title="查看"><i class="glyphicon glyphicon-eye-open"></i></a>
...
<input  class="btn btn-primary" type="button" value=" 移动到 " name="delete" onclick="if(getSelect(this.form) && confirm('确实要移动ID为('+getSelect(this.form)+')的类吗?')){this.form.action='<?php echo modify('act/batch',true);?>'; this.form.batch.value='move'; this.form.submit();}"/>
