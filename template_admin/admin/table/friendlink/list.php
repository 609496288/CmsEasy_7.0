...
<a href="{$base_url}/index.php?case=table&act=add&table=friendlink&admin_dir={get('admin_dir')}&site=default" class="btn btn-primary">添加友情链接</a>
<a href="{$base_url}/index.php?case=table&act=setting&table=friendlink&admin_dir={get('admin_dir')}&site=default" class="btn btn-info">友情链接配置</a>
