...
<td align="center">
<a title="点击编辑用户组！" href="<?php echo modify("act/edit/table/$table/id/$d[$primary_key]");?>" title="编辑"><i class="glyphicon glyphicon-edit"></i></a>
&nbsp;&nbsp;
<a title="确定要删除吗？" onclick="javascript: return confirm('确实要删除吗?');" href="<?php echo modify("/act/delete/table/$table/id/$d[$primary_key]/token/$token");?>" title="删除"><i class="glyphicon glyphicon-trash"></i></a>
