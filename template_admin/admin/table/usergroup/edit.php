			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                      ...
                      <tr>
                          <td colspan="1" width="120" class="col" valign="center"><input class="func" type="checkbox" name="powerlist[func_security]" {getchecked($data['powerlist'],'func_security')} value="1" id="func_security">
                              安全防护</td>
                          <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                                  <tr>
                                      <td class="unit"><input class="func func_security" type="checkbox" name="powerlist[func_filecheck]" {getchecked($data['powerlist'],'func_filecheck')} value="1" />
                                          文件校对</td>
                                      <td class="unit"><input class="func func_security" type="checkbox" name="powerlist[func_scan]" {getchecked($data['powerlist'],'func_scan')} value="1" />
                                          木马查杀</td>
                                  </tr>
                              </table></td>
                      </tr>
                      <tr>
                          <td colspan="1" width="120" class="col" valign="center"><input class="func" type="checkbox" name="powerlist[func_update]" {getchecked($data['powerlist'],'func_update')} value="1" id="func_update"> 检测更新</td>
                          <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                                  <tr>
                                      <td class="unit"></td>
                                  </tr>
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          <td class="unit"><input class="templates template_manage" type="checkbox" name="powerlist[system_template]" {getchecked($data['powerlist'],'system_template')} value="1" />
                            模板选择</td>
                            <td class="unit"><input class="templates template_manage" type="checkbox" name="powerlist[template_visual]" {getchecked($data['powerlist'],'template_visual')} value="1" />
                                可视化编辑</td>
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          ...
                          <td class="unit"><input class="templates templatetag_add" type="checkbox" name="powerlist[templatetag_add_category]" {getchecked($data['powerlist'],'templatetag_add_category')} value="1" />
                            添加栏目标签</td>
                            <td class="unit"><input class="templates templatetag_add" type="checkbox" name="powerlist[templatetag_add_special]" {getchecked($data['powerlist'],'templatetag_add_special')} value="1" />
                                添加专题标签</td>
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          ...
                          <td class="unit"><input class="templates templatetag_list" type="checkbox" name="powerlist[templatetag_list_category]" {getchecked($data['powerlist'],'templatetag_list_category')} value="1" />
                            栏目标签列表</td>
                            <td class="unit"><input class="templates templatetag_list" type="checkbox" name="powerlist[templatetag_list_special]" {getchecked($data['powerlist'],'templatetag_list_special')} value="1" />
                                专题标签列表</td>
                  ...
                  <tr>
                    ...
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                      ...
                      <tr>
                          <td colspan="1" width="120" class="col" valign="center"><input class="seo" type="checkbox" name="powerlist[seo_xiongzhang]" {getchecked($data['powerlist'],'seo_xiongzhang')} value="1" id="seo_xiongzhang"> 熊掌号推送</td>
                          <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                                  <tr>
                                      <td class="unit"></td>
                                  </tr>
...
GOOGLE生成</td>
				    ...
				    <tr>
                    <td colspan="1" width="120" class="col" valign="center"><input class="cache" type="checkbox" name="powerlist[cache_wap_manage]" {getchecked($data['powerlist'],'cache_wap_manage')} value="1" id="cache_wap_manage">
                      手机生成管理</td>
                    <td colspan="3" class="col" valign="center"><table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          <td class="unit"><input class="cache cache_wap_manage" type="checkbox" name="powerlist[cache_manage_wap_content]" {getchecked($data['powerlist'],'cache_manage_wap_content')} value="1" />
                            手机内容生成</td>
                          <td class="unit"><input class="cache cache_wap_manage" type="checkbox" name="powerlist[cache_manage_wap_category]" {getchecked($data['powerlist'],'cache_manage_wap_category')} value="1" />
                            手机栏目生成</td>
                          <td class="unit"><input class="cache cache_wap_manage" type="checkbox" name="powerlist[cache_manage_wap_index]" {getchecked($data['powerlist'],'cache_manage_wap_index')} value="1" />
                            手机首页生成</td>
                          <td class="unit"><input class="cache cache_wap_manage" type="checkbox" name="powerlist[cache_manage_wap_type]" {getchecked($data['powerlist'],'cache_manage_wap_type')} value="1" />
                            手机分类生成</td>
                          <td class="unit"><input class="cache cache_wap_manage" type="checkbox" name="powerlist[cache_manage_wap_special]" {getchecked($data['powerlist'],'cache_manage_wap_special')} value="1" />
                            手机专题生成</td>
                        </tr>
                        <tr>
                          <!-- <td class="unit"><input class="cache cache_manage" type="checkbox" name="powerlist[cache_area]" {getchecked($data['powerlist'],'cache_area')} value="1" />
                            地区生成</td> -->
                          <td class="unit"><input class="cache cache_wap_manage" type="checkbox" name="powerlist[cache_manage_wap_tag]" {getchecked($data['powerlist'],'cache_manage_wap_tag')} value="1" />
                            手机标签生成</td>
