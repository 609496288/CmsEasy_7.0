...
<script type="text/javascript" src="{$base_url}/js/jquery.min.js"></script>
 ...
 <div class="logo"><img src="{$skin_admin_path}/images/logo-login.png"></div>
...
<input type="hidden" name="submit" value="提交">
        ...
        <input autocomplete="off" name="username" type="text" id="username" class="form-control" placeholder="用户名" tabindex="1" required autofocus>
        <label for="inputPassword" class="sr-only">密码</label>
        <input autocomplete="off" name="password" type="password" id="password" class="form-control" placeholder="密码" tabindex="2" required>
