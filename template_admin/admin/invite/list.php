...
<td align="center" class="catname"><?php echo $d['isuse']?'<i class="glyphicon glyphicon-ok"></i>':'<i class="glyphicon glyphicon-remove"></i>';?></td>
<td align="center" class="manage"><a onclick="javascript: return confirm('确实要删除吗?');" href="<?php echo url('invite/del/id/'.$d['inviteid']);?>" title="删除"><i class="glyphicon glyphicon-trash"></i></td>
</tr>
{/loop}
      </tbody>
    </table>
