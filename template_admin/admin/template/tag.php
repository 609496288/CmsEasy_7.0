...
<div id="position">
<a href="javascript:history.back(-1)" title="返回上一页"><img alt="返回上一页" src="{$skin_admin_path}/undo.gif" style="float:right;" /></a>当前位置：模板注释
</div>



<div class="padding10">
<img src="{$skin_admin_path}/wj.gif" style="margin-right:10px;" />欢迎来到编辑模板注释页面。您可以编辑模板注释，这样在分类和内容选择模板时会更方便。
</div>
