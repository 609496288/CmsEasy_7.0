      ...
      <tr>
          ...
          <td class="manage" align="left">{$dir}</td>
           <td class="manage" align="center">
            <input type="button" onclick="javascript:if(confirm('确实要 【恢复】 备份档案 ( {$dir} ) 吗?' )) location.href='<?php echo url('database/dorestore/db_dir/'.$dir);?>';"  class="btn btn-view" value=" 还原 " />
           </td>
        </tr>
       {/loop}
