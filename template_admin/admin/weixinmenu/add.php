...
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="right" title="设置为菜单则可以用于添加二级菜单，点击此菜单将会展开二级菜单！"></span>
...
<div class="caidantype_3" style="display:none">
		<dl>
			...
			<dd><div class="blank10"></div>
				<textarea name="txt" class="textarea gens nonull"  value="请填写回复内容" onfocus="if(this.value=='请填写回复内容') {this.value=''}" onblur="if(this.value=='') this.value='请填写回复内容'">请填写回复内容</textarea><span class="hotspot" onmouseover="tooltip.show('微信能够识别电话号码，支持点击电话号码直接拨打！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
...
<div class="blank10"></div>
                <input type="text" name="pic[]" id="pic1" class="form-control"  value='请填写图片调用地址' class="form-control" onfocus="if(this.value=='请填写图片调用地址') {this.value=''}" onblur="if(this.value=='') this.value='请填写图片调用地址'" /><span class="hotspot" onmouseover="tooltip.show('填写图片调用地址！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			...
			<dl>
				<div class="blank10"></div>
				<dd style='position:relative;'>
					<textarea name="intro" class="textarea"  value="请填写描述内容" onfocus="if(this.value=='请填写描述内容') {this.value=''}" onblur="if(this.value=='') this.value='请填写描述内容'">请填写描述内容</textarea><span class="hotspot" onmouseover="tooltip.show('多图文内容展示时候，将不会显示描述内容！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
...
<div class="v52fmbx_dlbox caidantype_4" style="display:none">
		...
		<dl>
			...
			<dd>
			<div class="blank10"></div>
				<input class="text nonull input" name="url"  value="请填写链接地址" onfocus="if(this.value=='请填写链接地址') {this.value=''}" onblur="if(this.value=='') this.value='请填写链接地址'" /><span class="hotspot" onmouseover="tooltip.show('填写菜单点击后跳转地址，格式为http://地址/！');" onmouseout="tooltip.hide();"><img src="{$skin_admin_path}/images/visual/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>
			</dd>
		</dl>
		</div>
</div>
