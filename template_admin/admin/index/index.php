...
.main-right-box ul {padding:20px 10px;}
...
.quick-btn {min-height:83px; margin:0px 10px 35px 5px; padding:15px 0px; background: #d9edf7;border:1px solid #bce8f1; color: #3a87ad; border-radius:2px; text-align:center;-moz-box-shadow:0px 8px 15px #ccc;
-webkit-box-shadow:0px 8px 15px #ccc;
box-shadow:0px 8px 15px #ccc;}


	
.quick-btn a {display:block; color: #3ca1ef;text-align:center;}
.quick-btn .glyphicon {display:block; height:38px; color:#3ca1ef;font-size:30px;}
.quick-btn:hover {background:#3ca1ef;color:#fff;border:1px solid #3ca1ef;}
.quick-btn:hover a,.quick-btn:hover .glyphicon {color:#fff;text-decoration:none}


.list-group-item {margin:0px 10px 10px 10px; -moz-box-shadow:0px 8px 15px #ccc;
-webkit-box-shadow:0px 8px 15px #ccc;
box-shadow:0px 8px 15px #ccc;}
...
input.btn-primary, a.btn-primary {padding:0px 25px; }
...
<!--
function lick(){
$("#admin-index-alert").hide();
}
window.setTimeout("lick()",5000);
//-->
</script>

<div id="admin-index-alert">
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=config&act=system&set=site&admin_dir={get('admin_dir')}&site=default" class="q1"><span class="glyphicon glyphicon-cog"></span>网站设置</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=table&act=add&table=archive&admin_dir={get('admin_dir')}&site=default" class="q2"><span class="glyphicon glyphicon-edit"></span>添加内容</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=table&act=list&table=orders&admin_dir={get('admin_dir')}&site=default" class="q3"><span class="glyphicon glyphicon-usd"></span>订单管理</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=cache&act=make_show&admin_dir={get('admin_dir')}&site=default" class="q4"><span class="glyphicon glyphicon-file"></span>生成HTML</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=config&act=remove&admin_dir={get('admin_dir')}&site=default" class="q5"><span class="glyphicon glyphicon-refresh"></span>更新缓存</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=table&act=list&table=category&admin_dir={get('admin_dir')}&site=default" class="q6"><span class="glyphicon glyphicon-list-alt"></span>栏目管理</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=table&act=list&table=type&admin_dir={get('admin_dir')}&site=default" class="q7"><span class="glyphicon glyphicon-list-alt"></span>分类管理</a>
</div>
</div>
</div>
...
<div class="row">
<div class="quick-btn">
<a href="{$base_url}/index.php?case=table&act=list&table=archive&admin_dir={get('admin_dir')}&site=default" class="q8"><span class="glyphicon glyphicon-list-alt"></span>内容管理</a>
</div>
</div>
</div>
...
&nbsp;<a href="{$base_url}/index.php?case=update&act=index&admin_dir={get('admin_dir')}&site=default" class="btn btn-primary btn-xs">检查更新</a></td>
</tr>
</table>
<div class="clearfix"></div>
</div>
